	...
	<div>
		...
		<div class="card-header bg-white d-flex justify-content-between px-2">
            <div class="mr-auto">
                <div class="input-group input-group-solid">
                    ...
                    <input class="form-control" type="search" @keyup.enter="applyFilter()" v-model="filter.search" placeholder="Search" aria-label="Search">
                </div>
            </div>
        </div>
		...
		<div v-if="selectedCheckBox.length > 0" class="d-flex justify-content-between px-2 mt-3 mb-2">
			<div class="text-dark small font-weight-midi d-inline-flex mt-1">
                {{selectedCheckBox.length}} transaction(s) selected
            </div>
	        ...
	        <table class="table table-striped">
	            ...
	            <tbody>
	                <tr v-for="(fee, key) in feeTransactions" :key="key" class="table-row">
	                    ...
	                    <td class="h7 font-weight-midi text-capitalize" data-colname="RECORD BY:">Pay Systen</td>
