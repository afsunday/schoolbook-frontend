        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white pr-2 pl-1 pb-0 pt-1">
                <ul class="nav nav-pills mt-2">
                    <li class="nav-item">
                        <a class="nav-link pl-2 pb-sm-3 pb-3 active" aria-selected="true">Batch History</a>
                    </li>
                </ul>
            </div>
        	                ...
        	                <tr v-for="(fee, key) in activeFees" :key="key" class="table-row">
        	                    ...
        	                    <td>
        	                        <div class="d-flex justify-content-between">
        	                            <div class="mr-4">
        	                                <span><a href="#" class="h7 text-decoration-none text-dark font-weight-midi">John tuition Fee 2019/2020 First Term</a></span>
        	                            </div>
