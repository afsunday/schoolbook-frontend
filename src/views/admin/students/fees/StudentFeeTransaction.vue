				...
				<div class="card-header bg-white d-flex justify-content-between px-2">
		            <div class="me-auto">
		                <div class="input-group">
		                    <input class="form-control bg-light" type="search" @keyup.enter="searchFeeTransaction()" v-model="feeSearch" placeholder="Search" aria-label="Search">
		                </div>
		            </div>
		        </div>
			                ...
			                <tr>
			                    <th class="wd-30">
			                        <div class="form-check-lg form-check">
		                                <input type="checkbox" ref="checkAllCheckBox" @click="checkAll($event)" class="form-check-input" id="sb-checkall-44" />
		                                <label class="form-check-label" for="sb-checkall-44"></label>
		                            </div>
			                    </th>
			                    <th>RECEIPT/NAME</th>
		                        <th>AMOUNT</th>
			                    ...
			                    <td>
			                        <div class="d-flex justify-content-between">
			                            <div class="me-4 me-sm-0">
			                                ...
			                                <h6 class="small text-muted text-break text-capitalize">John tuition Fee 2019/2020 First Term</h6>
			                            </div>
