            ...
            <VeeForm v-slot="{ handleSubmit, errors }">           
                    ...
                    <div v-if="loadingState.loaded && Object.keys(form.guardian).length > 0" class="card-body px-2 px-sm-3 pt-2 pb-3">
                        ...
                        <div class="row g-3 mt-3">
                            <div class=" col-md-4">
                                ...
                                <select class="form-select form-select-lg" v-model="form.guardian.title">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select form-select-lg" v-model="form.guardian.gender">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select form-select-lg" v-model="form.guardian.nationality">
                ...
                <div class="card border-0 shadow-sm mt-3">
                    ...
                    <div class="card-body px-2 px-sm-3">
                        <div v-if="loadingState.loaded && Object.keys(form.guardian).length > 0" class="row g-3">
                            <div v-for="ward in form.wards" class="col-md-4 mb-2">
                                <div class="border rounded-top rounded-end px-2 py-3">
                                    <div class="d-flex mt-2">
                                        ...
                                        <div class="text-break overflow-auto"> 
                                            ...
                                            <div class="d-flex flex-wrap">
                                                <div class="d-inline-flex text-dark me-2 me-sm-3">
                                                    <div class="me-1"><i class="icon icolist icon-lg"></i></div>
                                                    <div :class="ward.status" class="ms-1 text-break text-capitalize small">{{ ward.status }}</div>
                                                </div>
                                                <div class="d-inline-flex text-dark me-sm-3">
                                                    <div class="me-1"><i class="icon icon-badges icon-lg"></i></div>
                                                    <div class="ms-1 text-break text-muted small">{{ ward.admission_number }}</div>
                                                </div>
                                                <div class="d-inline-flex text-dark">
                                                    <div class="me-1"><i class="icon icon-repo icon-lg"></i></div>
                                                    <div class="ms-1 text-break text-muted small">{{ ward.classname }}</div>
                                                </div> 
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-2">
                                        <div class="form-check-lg form-check">
                                            <input type="checkbox" class="form-check-input" v-model="ward.emergency" :checked="ward.emergency" :id="ward.student_id">
                                            <label class="form-check-label" :for="ward.student_id">
                ...
                <div class="d-flex justify-content-center mt-3">
                    <loading-button class="btn btn-secondary btn-block px-4" :loading="loadingState.btnLoading" @btnEvent.prevent="handleSubmit(updateGuardian)">Update Guardian</loading-button>
                </div>
