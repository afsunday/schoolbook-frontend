                    ...
                    <VeeForm v-slot="{ handleSubmit, errors }">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <Field name="pic" as="input" type="file" class="form-control form-control-lg pb-5 pt-4" @change="form.pic = $event.target.files" />
                        ...
                        <div class="form-row justify-content-center mt-3">
                            <div class="col-md-3">
                                <loading-button class="btn btn-ripple ripple btn-block" :loading="loadingState.btnLoading" @btnEvent.prevent="handleSubmit($event, createStaff)">Create Staff</loading-button>
                            </div>
                        </div>
                    </VeeForm>
